...
cmd("ip link set xaui0 nomaster; ip link set xaui0 up mtu 1500",2)
cmd("ip link set xaui1 nomaster; ip addr flush dev xaui1; ip addr add 10.9.9.2/24 dev xaui1; ip link set xaui1 up mtu 1500",2)
